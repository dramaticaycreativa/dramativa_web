  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "curtain-rise": { "0%": { transform: "translateY(20px)", opacity: "0" }, "100%": { transform: "translateY(0)", opacity: "1" } },
        spotlight: { "0%,100%": { opacity: "0.85" }, "50%": { opacity: "1" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.25s ease-out",
        "accordion-up": "accordion-up 0.25s ease-out",
        "fade-in": "fade-in 0.6s var(--ease-curtain) both",
        "fade-up": "fade-up 0.7s var(--ease-curtain) both",
        "scale-in": "scale-in 0.4s var(--ease-curtain) both",
        "curtain-rise": "curtain-rise 0.8s var(--ease-curtain) both",
